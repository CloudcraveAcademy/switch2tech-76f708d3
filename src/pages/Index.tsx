...
const Index = () => {
  ...
  return (
    <Layout withPadding={false}>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-[#03045E] to-[#023E8A] text-white">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1172&q=80')] bg-cover bg-center opacity-10"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 relative z-10">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/courses">
                <Button size="lg" className="bg-brand-light hover:bg-brand text-white font-semibold">
                  Explore Courses
                </Button>
              </Link>
              <Link to="/register">
            ...
            <div className="mt-12 flex flex-wrap gap-6">
              <div className="flex items-center">
                <CheckCircle className="h-6 w-6 mr-2 text-brand-light" />
                <span className="text-white/90">Expert Instructors</span>
              </div>
              <div className="flex items-center">
                <CheckCircle className="h-6 w-6 mr-2 text-brand-light" />
                <span className="text-white/90">Job-focused Training</span>
              </div>
              <div className="flex items-center">
                <CheckCircle className="h-6 w-6 mr-2 text-brand-light" />
                <span className="text-white/90">Internship Opportunities</span>
              </div>
            </div>
          </div>
        </div>
