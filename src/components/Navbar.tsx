...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    console.log("Should show login buttons:", !loading && !userData);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-1">
            <Link
              to="/"
              className="py-2 px-3 rounded-md text-sm font-medium text-foreground hover:bg-accent/10"
            >
              Home
            </Link>
            <Link
            ...
            {/* Always show either login/register OR user menu - never both, never neither */}
            {!loading && (
